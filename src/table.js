...
function UsersTable() {
  ...
  function ListUsers() {
    return (
      <>
        <Table striped bordered responsive className="text-center align-middle w-auto mx-auto table-danger">
          <thead className="table-danger text-nowrap" >
            <tr>
              <th>Nombre</th>
              <th>Apellido</th>
              <th>Edad</th>
          ...
          <tbody>
            { usersOrderAge.map((user, index) => (
              <tr key={index} className="table-danger text-nowrap">
